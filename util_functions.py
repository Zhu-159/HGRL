...
def load_k_fold(data_name, seed):
    ...
    num_len = int(np.ceil(len(drug_id) * 0.95))  # keep only the first 95% of observed positives to set the sparsity level
    ...
    # number of training and test edges (90% train / 10% test split)
